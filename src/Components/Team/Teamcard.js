...
function Teamcard(props) {
    return (
        <>
            <Fade triggerOnce={true} style={{
            ...
            }} className="shadow-2xl bg-no-repeat z-50 hover:shadow-gray-900 hover:shadow-2xl transition duration-300 max-w-sm scale-90 lg:scale-100 h-full text-center w-[80%] lg:w-[20%] m-5 rounded-md">
                <div className="transition-transform hover:scale-[1.15]  duration-300">
                    ...
                    <div className="text-center h-32 bg-white  p-2">
                        <h1 className= {`pt-2 font-semibold ${props.name.length> 20 ? "text-md" : "text-xl" }   text-gray-900 tracking-wide capitalize `} >
                            {props.name}
                        </h1>
                        <h3 className="pt-2 pb-4 text-sm text-slate-400 font-semibold tracking-wider capitalize">
                            {props.role}
                        </h3>
