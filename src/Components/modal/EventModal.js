                ...
                <Zoom as="div" duration={200} className='flex flex-col h-[100vh] justify-center items-center fixed top-0 right-0 left-0 z-[999] w-[100vw]'>
                    <div onClick={(e) => e.stopPropagation()} id="extralarge-modal" tabIndex="-1" className="   md:inset-0  flex items-center justify-center justify-items-center overflow-x-hidden  overflow-y-hidden  ">
                        <div className="relative p-4 w-full max-w-7xl h-full md:h-auto backdrop-lg  shadow-lg  border-0  " >
                            {/* <!-- Modal content --> */}
                            <div className="relative bg-blend-color  shadow  bg-clip-padding backdrop-blur bg-[#f5f5f5] rounded-2xl p-4 ">
                                {/* <!-- Modal header --> */}
                                <div className="flex flex-wrap justify-between items-center p-3 md:p-4   border-b ">
                                    ...
                                    <button type="button" className="text-gray-900  gap-1 text-md p-1.5 ml-auto inline-flex items-center " data-modal-toggle="extralarge-modal"
                                ...
                                <div className="overflow-y-scroll sm:overflow-y-auto  h-[80vh] sm:h-auto p-1 sm:flex sm:flex-row md:flex md:flex-row  ">
                                    ...
                                    <div className="align-middle px-2 md:p-10 pt-4   space-y-6  sm:overflow-y-scroll lg:overflow-hidden  sm:h-[75vh] md:h-full">
                                        <div>
                                            <div className="py-3 text-gray-900 text-4xl bold"> <span className='font-bold'>Events Details </span>
                                                <br />

                                            </div>

                                            <div className=" text-gray-900"> <span className='font-semibold' >Name - </span> {props.name}</div>

                                            <div className=" text-gray-900">  <span className='font-semibold' >Category - </span> {props.category}</div>
                                            <div className=" text-gray-900">  <span className='font-semibold' >Date - </span>  {props.date}  </div>
                                            <div className=" text-gray-900">  <span className='font-semibold' >Attended by - </span>  {props.attended}  </div>
                                            <div className=" text-gray-900">  <span className='font-semibold' >Oragnizer - </span>  {props.oragnizer}  </div>
                                        </div>
                                        <div className="">

                                            <h1 className="text-gray-900/100 text-4xl font-bold py-3">Description</h1>
